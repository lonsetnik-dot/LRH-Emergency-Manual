...
/* dist/ and dist-demo/ are build output — the same tools a second and third time, from
   build.mjs and demo-build.mjs — and node_modules/ is dev tooling. */
const NOT_A_TOOL = new Set(['dist/', 'dist-demo/', 'node_modules/']);
